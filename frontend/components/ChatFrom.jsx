          ...
          >
            {chat.counselor ? (
              <p className="flex items-end text-left">
                <BsRobot className="mr-2 w-8 h-8 inline text-3xl" />
