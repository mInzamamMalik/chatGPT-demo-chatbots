export default function Button({ children }) {
  return (
    <div className="group relative inline-flex items-center justify-center overflow-hidden rounded-full border-2 border-primary p-4 px-6 py-3 font-medium text-primary shadow-md transition duration-300 ease-out">
